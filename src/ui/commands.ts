...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: "/background", description: "Run a task in the background — /background <task>" },
  { name: "/runs", description: "List background runs and their status" },
  { name: "/attach", description: "Follow a background run live — /attach <runId>" },
  { name: "/onboarding", description: "Replay the first-run onboarding walkthrough" },
